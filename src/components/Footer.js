                                ...
                                <div className="footer footer__contact">
                                    ...
                                    <div className="footer__address">
                                        <div className="footer__map">
                                            ...
                                            <a href="# ">Tan Phu District, Ho Chi Minh City, VN</a>
                                        </div>
                                        ...
                                        <div className="footer__mail">
                                            ...
                                            <a href="# ">buinghiemtrang@gmail.com</a>
                                        </div>
                                    </div>
                                    <div className="footer__socials">
                                        <a href="https://www.facebook.com/buinghiemtrang/">
                                            <i className='bx bxl-facebook'></i>
                                        </a>
                                        <a href="https://www.instagram.com/bn_t.201/">
                                            <i className='bx bxl-instagram'></i>
                                        </a>
                                        <a href="https://www.linkedin.com/in/buinghiemtrang/">
                                            <i className='bx bxl-linkedin'></i>
                                        </a>
                                        <a href="https://github.com/buinghiemtrang">
